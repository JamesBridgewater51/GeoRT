...
bool SDKMinimalClient::SetupHandNodes(uint32_t p_SklIndex)
{
	...
	ManusVec3 t_Fingers[t_NumFingers * t_NumJoints] = {
		...
		CreateManusVec3(0.000000f, 0.000000f, 0.051287f), //Middle MCP joint (relative to hand root)
		CreateManusVec3(0.000000f, 0.000000f, 0.041861f), //Middle PIP joint (relative to MCP)
